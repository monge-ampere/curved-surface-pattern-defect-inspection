...
写这个系列，不是为了争论谁说了什么，也不是为了做情绪化的追责，而是为了把这套算法系统以一种更规范、更有灵魂、也更能帮助后续研发者理解与复现的方式保留下来。
...
这里面“规范重述”四个字，不是为了显得书面，而是因为我越来越意识到：  
**一个真正做成过的工业算法系统，如果没有被以合适的结构讲清楚，最后很可能会被留存在错误文本里。**
...
反过来，如果叙述本身是错的，那么即使表面上留下一堆名词、流程图和模块图，也未必真的能把那个系统保留下来。

所以我写这个系列，并不是为了把过去重复一遍，而是为了把它**重新建立为一个可理解、可传递、可复现的技术对象**。
