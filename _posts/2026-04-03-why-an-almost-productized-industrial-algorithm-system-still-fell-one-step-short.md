...
但工业项目真正难的地方，从来不只是“能不能把算法做出来”，而是：

> **当算法已经成立之后，是否还有一整条足够可靠的产品化链条，把它真正接住。**
...
前面第七讲我已经反复讲过，这套系统里的“实施”根本不是普通意义上的实施。它不是点点工具、改改参数那么简单，而是一条高门槛的模板生产链和参数闭环链。实施工程师必须同时具备：

- 对图像处理基本原理的理解；
- 对模板、骨架、中心点质量的判断能力；
- 对参数变化如何影响漏检和过杀的经验；
- 把实验室调试迁移到现场、再从现场继续收敛到上线的能力。

也就是说，这里真正需要的不是普通 `support`，而是贴近现场的应用算法工程师。
